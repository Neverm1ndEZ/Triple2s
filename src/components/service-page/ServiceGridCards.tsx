...
export default function GridCards() {
	...
	const Card = ({
		...
		<div
			className={`
        flex flex-col gap-3 rounded-3xl bg-[#18181899] backdrop-filter backdrop-blur-xl bg-opacity-60
      ...
      `}
		>
			...
			<p className="text-base sm:text-lg text-gray-300">{card.desc}</p>
		</div>
	);
	...
	return (
		<section className="w-full overflow-hidden py-8 sm:py-12 lg:py-24">
			...
			<h1 className="text-3xl sm:text-4xl lg:text-5xl font-light leading-snug mb-8 sm:mb-12 lg:mb-20 text-center lg:text-left max-w-[500px]">
			...
			{/* CTA section with responsive spacing */}
			<div className="flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-10 mt-12 sm:mt-16 lg:mt-24 px-4">
				<h2 className="text-2xl sm:text-3xl lg:text-5xl font-light leading-normal text-center lg:text-left">
					Need custom service that aligns with your business objectives? Get a
					quote.
				</h2>
				<button className="border border-white rounded-full p-6 sm:p-8 lg:p-10 hover:scale-110 transition duration-200 ease-in-out">
